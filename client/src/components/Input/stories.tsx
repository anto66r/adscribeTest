...
export const Text = (): ReactElement => (
  <Flex direction={Direction.column} horizontal={Horizontal.left}>
    ...
    />
    <Input id="with-error-03" type={Type.text} hasError onChange={action('input-change-value')} />
    <Input id="disabled-04" type={Type.text} disabled onChange={action('input-change-value')} />
  </Flex>
);
